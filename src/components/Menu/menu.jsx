...
function FunctionsMenu({
  ...
  // console.log("onGetSlideInforFromMEanu",onGetSlideInfo)
  ...
  useEffect(() => {
    if (onSearchSelectedData) {
      if (
        onSearchSelectedData.type === "textBox" ||
        onSearchSelectedData.type === "textbox"
      ) {
        setIsOpen(true);
              ...
              <Flex w="100%" h="82vh" direction="column" bgColor="#FCFCFC">
                ...
                <Flex>
                  {showReport ? (
                    ...
                    <SynopticReport
                      userInfo={userInfo}
                      onSaveSynopticReport={onSaveSynopticReport}
                      getSynopticReport={getSynopticReport}
                      synopticType={synopticType}

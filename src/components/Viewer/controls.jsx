...
function ViewerControls({
  ...
  setLoadUI,
	...
	const [feedKI67,setFeedKI67] = useState({})
	...
	const showAnalysisData = async (resp) => {
		...
		if (resp && typeof resp === "object") {
			...
			console.log("celllllsssss",cells);
			// console.log("analysedData", vhut);
	...
	const handleShowAnalysis = async () => {
		...
		console.log(annotationObject?.analysedROI);
	...
	useEffect(() => {
		if (vhutSubscriptionData) {
          ...
          setLoadUI(true);
				...
				// if(data.kiResults.pos_contours.length > 0 || data.kiResults.neg_contours.length > 0 ) {
	...
	const runKI67 = async()=>{
		...
		// console.log("slideID", slideId);
		// console.log("body....", body);
		const originalBody ={...body, notifyHook: `${Environment.VIEWER_URL}/notify_KI67`,annotationId:"",}

...
const AiModels = ({
  ...
  const { onTumorAnalysis, analysisData, analysisError } =
    onGetTumorGleasonAnalysis;

  const { subscription, subscriptionError } = getTumorGleasonResult(
    slideId,
    modelType
  );

  // console.log("subscriptionAI", subscription);
  // console.log("subscriptionErrorAI", subscriptionError);
